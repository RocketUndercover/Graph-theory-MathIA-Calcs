...
shortest_paths = dict(nx.floyd_warshall_predecessor_and_distance(G, weight="weight"))
predecessors = shortest_paths[0]
distances = shortest_paths[1]

# Extract the shortest path from JFK to SIN
...
flight_path = get_path(predecessors, "JFK", "SIN")
total_time = distances["JFK"]["SIN"]
...
plt.title("Flight Path from JFK to SIN using Floyd-Warshall")
